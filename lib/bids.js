 ...
 *
 * The timestamp is not decoration. ipo-active-category lags the rest of NSE
 * badly: on a live issue it was measured three days behind the issue list,
 * still showing the previous Friday's book while the same company was
 * twenty-three times subscribed. Rendering those share counts without
 * saying when they are from would read as live.
 */
